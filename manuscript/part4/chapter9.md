...
1990 年代、最初の答えは壮大だった。バラバラな機械やソフトを、**一つの完璧な共通規格で、統一してしまえ。** その象徴の一つが、**CORBA** だった。
...
1990 年代初め、Web は、拍子抜けするほど単純な仕組みで始まった。文書に少しだけ印をつける書き方――**HTML**。その文書を「ください」と頼んで受け取るだけの、素朴な約束ごと――**HTTP**。そして、受け取った文書を映す窓――ブラウザ。どれも、厳密とはほど遠い。多少いいかげんでも、動く。だからこそ、誰でも参加できた。
