...
![怖い→触らない→古びる→もっと怖い、と一周してさらに怖くなる恐怖の悪循環の図](../assets/fig-4-2.svg)
...
![一度きりの本番の 1202 と、何度でもわざと鳴らす FAIL の対比](../assets/fig-4-1.svg)
...
![変更するたびに検査が走り、通れば手を入れられ、壊せばその場で気づける安全網の図](../assets/fig-4-3.svg)
