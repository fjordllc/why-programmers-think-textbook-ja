...
1980 年代半ば、ここで、さきほどの技術者が動く。**リチャード・ストールマン（Richard Stallman）。**
...
世界中の見知らぬ技術者たちが、自分の手元から少しずつ、部品を持ち寄りはじめた。やがて 1990 年代初め、その流れに、一人の学生が書いた中核部分が合流する。**リーナス・トーバルズ（Linus Torvalds）**――のちに、多くのサーバーやスマートフォンの土台になる基盤を書きはじめた人だ。誰のものでもないソフトが、本物の、実用に耐えるものとして組み上がっていった。
