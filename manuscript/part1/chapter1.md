...
![機能数の増加に対し、気を配る関係の数が直線を超えて急増する曲線](../assets/fig-1-1.svg)
...
![道具で減らせる偶有的な複雑さの内側に、消えない本質的な複雑さが残ることを示す入れ子の図](../assets/fig-1-2.svg)
...
![一つの仕事だけをする小さな道具を、縦棒でつないで大きな仕事にするパイプの図](../assets/fig-1-3.svg)
